...
with open(args.outFile, 'w') as outFile:
    ...
    for index, eq in enumerate(equations):
        ...
        function_symbols=getSymbols(eq)
        sorted_function_symbols=sorted([x for x in function_symbols if not x[0:2]=="kd"])+[x for x in function_symbols if x[0:2]=="kd"]
        

        outFile.write("def eqtn"+str(index)+"("+",".join(sorted_function_symbols)+"):\n")
